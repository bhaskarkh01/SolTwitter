...
declare_id!("DQk2cmc2UgS66LQbebkKetHgnsMbh4zvLpD5ocyZubb1");
...
pub enum TweetErrors {
    ...
    #[msg("The tweet topic is too long, should be less than 50 chars")]
    TopicTooLong,

    #[msg("The tweet content is too long, should be less than 280 chars")]
    ContentTooLong,
}
